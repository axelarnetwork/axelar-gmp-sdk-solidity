...
/**
 * @title IAxelarGMPExpressExecutable
 * @notice Interface for the Axelar GMP Express Executable contract.
 */
interface IAxelarGMPExpressExecutable is IAxelarGMPExecutable {
    // Custom errors
